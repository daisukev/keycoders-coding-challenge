const LockSVG = ({ width = 25, height = 25, fill = "#000000" }) => {
  return (
    ...
    >
      <path
        d="M74,80H26c-3.3,0-6-2.7-6-6V26c0-3.3,2.7-6,6-6h48c3.3,0,6,2.7,6,6v48C80,77.3,77.3,80,74,80z M28.1,30v40
	c0,1.1,0.9,2,2,2H70c1.1,0,2-0.9,2-2V30c0-1.1-0.9-2-2-2H30.1C29,28,28.1,28.9,28.1,30z"
      />
      <path
        d="M66.3,47.3l-1.2-3.8c-0.3-1-1.5-1.6-2.5-1.3L53.9,45v-8.6c0-1.1-0.9-2-2-2h-4c-1.1,0-2,0.9-2,2v8.6l-8.5-2.8
